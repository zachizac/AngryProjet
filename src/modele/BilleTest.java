 ...
 */
public abstract class BilleTest {
...
//----------------- classe Bille-------------------------------------
     ...
     * @param couleur
     */
    protected BilleTest(Vecteur position, double rayon, Vecteur vitesse,
        ...
        this.clef = BilleTest.prochaineClef++;
    }
     ...
     * @param couleur
     */
    public BilleTest(Vecteur position, double rayon, Vecteur vitesse, Color couleur) {
