...
Bille bille1 =     new RectiligneUniforme(new PasseMuraille(new BilleNue(centreBille1, rayonBille1, vitesseBille1, Color.blue)));
billes.add(bille1);

Vecteur centreBille2 = new Vecteur(20,50);
double rayonBille2 = 15;
Vecteur vitesseBille2 = new Vecteur (5,-5);
Bille bille2 = new RectiligneUniforme(new PasseMuraille(new BilleNue(centreBille2, rayonBille2, vitesseBille2, Color.blue)));
billes.add(bille2);
